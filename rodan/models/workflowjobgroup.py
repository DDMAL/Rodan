...
class WorkflowJobGroup(models.Model):
    ...
    **Fields**
    ...
    workflow = models.ForeignKey("rodan.Workflow", related_name="workflow_job_groups", on_delete=models.CASCADE, db_index=True)
    origin = models.ForeignKey("rodan.Workflow", related_name="used_as_workflow_job_groups", blank=True, null=True, on_delete=models.SET_NULL, db_index=True)
