...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.uuid'
        db.add_column('rodan_page', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)

        # Adding field 'Project.uuid'
        db.add_column('rodan_project', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.uuid'
        db.delete_column('rodan_page', 'uuid')

        # Deleting field 'Project.uuid'
        db.delete_column('rodan_project', 'uuid')
