...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.page_image'
        db.alter_column('rodan_page', 'page_image', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'Page.compat_page_image'
        db.alter_column('rodan_page', 'compat_page_image', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'Result.result'
        db.alter_column('rodan_result', 'result', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Page.page_image'
        db.alter_column('rodan_page', 'page_image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Page.compat_page_image'
        db.alter_column('rodan_page', 'compat_page_image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Result.result'
        db.alter_column('rodan_result', 'result', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        'rodan.result': {
            ...
            'result': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True'}),
