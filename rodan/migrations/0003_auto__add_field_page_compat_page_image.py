...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.compat_page_image'
        db.add_column('rodan_page', 'compat_page_image',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.compat_page_image'
        db.delete_column('rodan_page', 'compat_page_image')
