...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.task_name'
        db.add_column('rodan_result', 'task_name',
                      self.gf('django.db.models.fields.CharField')(default='oneoff', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.task_name'
        db.delete_column('rodan_result', 'task_name')
