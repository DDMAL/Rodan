...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.image_file_size'
        db.add_column('rodan_page', 'image_file_size',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Page.creator'
        db.add_column('rodan_page', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages', null=True, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Workflow.description'
        db.alter_column('rodan_workflow', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Page.image_file_size'
        db.delete_column('rodan_page', 'image_file_size')

        # Deleting field 'Page.creator'
        db.delete_column('rodan_page', 'creator_id')


        # User chose to not deal with backwards NULL issues for 'Workflow.description'
        raise RuntimeError("Cannot reverse this migration. 'Workflow.description' and its values cannot be restored.")
