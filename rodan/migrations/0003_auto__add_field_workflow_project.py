...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workflow.project'
        db.add_column('rodan_workflow', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='workflows', to=orm['rodan.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workflow.project'
        db.delete_column('rodan_workflow', 'project_id')
