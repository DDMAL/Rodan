...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkflowJob.job_settings'
        db.alter_column('rodan_workflowjob', 'job_settings', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Result.workflow_job'
        db.alter_column('rodan_result', 'workflow_job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rodan.WorkflowJob'], null=True))

    def backwards(self, orm):

        # Changing field 'WorkflowJob.job_settings'
        db.alter_column('rodan_workflowjob', 'job_settings', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'Result.workflow_job'
        raise RuntimeError("Cannot reverse this migration. 'Result.workflow_job' and its values cannot be restored.")
    ...
    models = {
        ...
        'rodan.workflowjob': {
            ...
            'job_settings': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
