...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rodan_job', (
            ...
            ('enabled', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.create_table('rodan_page', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rodan.Project'])),
    ...
    def backwards(self, orm):
        # Deleting model 'RodanUser'
        db.delete_table('rodan_rodanuser')
