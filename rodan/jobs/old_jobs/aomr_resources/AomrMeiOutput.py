...
# from pymei import MeiNamespace, MeiAttribute

from pymei import MeiElement, MeiNamespace, XmlExport, MeiAttribute, MeiDocument
...
class AomrMeiOutput(object):
    ...
    def __init__(self, incoming_data, original_image, page_number=None):
        ...
        self.staffdef.addAttribute("n", self.staff_num) 
        ...
        self.staffel.addAttribute("n", self.staff_num)  
    ...
    def _create_neume_element(self):
        ...
        # lg.debug("\nglyph:{0}, note_octaves:{1}".format(self.glyph, note_octaves))   
