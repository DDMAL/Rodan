...
module_loader('gamera.plugins.color', load_gamera_module)
module_loader('gamera.plugins.misc_filters', load_gamera_module)
...
module_loader('rodan.jobs.gamera.custom.segmentation.segmentation_cc')
