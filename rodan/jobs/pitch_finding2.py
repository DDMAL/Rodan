...
@utils.rodan_task(inputs=('tiff', 'xml'), others=['page_sequence'])
def pitch_find(image_filepath, xml_filepath, page_sequence, **kwargs):
    ...
    mei_file = AomrMeiOutput(recognized_glyphs, image_filepath.encode('ascii', 'ignore'), page_number) 
