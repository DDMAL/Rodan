...
from rodan.serializers.classifier import ClassifierSerializer
...
class ProjectSerializer(serializers.HyperlinkedModelSerializer):
    ...
    classifiers = ClassifierSerializer(many=True, required=False, read_only=True)
    uuid = serializers.Field(source="uuid")

    class Meta:
        model = Project
        read_only_fields = ('created', 'updated')
        fields = ("uuid", "url", "name", "description", "creator", "pages", "workflows", "classifiers")
